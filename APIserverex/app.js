// express:: library that allows to  create a server
...
import axios from 'axios';     // 55K (gzipped: 20.3k)
import * as dotenv from 'dotenv';  //6.2 (gzipped: 2.8k)
...
// HERE WE WILL CRERATE OUR ROUTES FOR OUR GET REQUEST TO RECIVE OUR DATA.
// this html for index.html
...
// create a route url for our API
